...
export const GetContentResponse = zod.object({
  ...
  "telegramChannelLink": zod.string(),
  "facebookLink": zod.string(),
  "tiktokLink": zod.string(),
  "instagramLink": zod.string(),
  "youtubeLink": zod.string(),
  "whatsappChannelLink": zod.string(),
...
export const UpdateContentBody = zod.object({
  ...
  "telegramChannelLink": zod.string().optional(),
  ...
  "whatsappChannelLink": zod.string().optional(),
  "supportPhone1": zod.string().optional(),
  "supportPhone2": zod.string().optional(),
