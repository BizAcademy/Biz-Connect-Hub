...
function formatContent(c: typeof siteContentTable.$inferSelect) {
  return {
    ...
    ambassadorsTitle: c.ambassadorsTitle,
    gainsTitle: c.gainsTitle,
    gainsSecondaryTitle: c.gainsSecondaryTitle,
    testimonialsTitle: c.testimonialsTitle,
    trainingsTitle: c.trainingsTitle,
    ctaTitle: c.ctaTitle,
    faqTitle: c.faqTitle,
    supportTitle: c.supportTitle,
    partnersTitle: c.partnersTitle,
    paymentMethodsTitle: c.paymentMethodsTitle,
    ...
    whatsappChannelLink: c.whatsappChannelLink,
